...
<style>
    body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('1658291711755_94_Toko Ritel.jpg'); /* Ganti 'path/to/your/image.jpg' dengan path ke gambar Anda */
                    ...
                    <div
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h4 class="text-info">Kasir Barokah</h4>
                            </div>
                            @error('status')
                            ...
                            <div class="card-body">
                                <form method="POST" action="/postlogin" class="needs-validation">
                                    ...
                                    <!-- <div class="form-group">
                                        <p>Lupa Password <a href="/forgot-password">Lupa</a></p>
                                    </div> -->
                                    <div class="form-group">
                                        <p>Daftar Baru? <a href="/daftar">Daftar</a></p>
                                    </div>

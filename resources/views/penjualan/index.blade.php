    ...
    <div class="section-body">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="position-absolute text-dark">Kasir</h4>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-dark">Kasir</h4>
                    </div>
                    <div class="card-body p-2">
                        <form action="/penjualan/bayar/{{$nomor}}" method="POST" id="form-bayar">
                            @csrf
                            ...
                            <button type="button" onclick="simpan()" class="btn m-1 btn-primary">Simpan</button>
                        </form>
                    </div>
                </div>
            </div>

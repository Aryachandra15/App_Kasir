...
@section('title', 'Kasir - Satuan Barang')
                        ...
                        <table class="table table-hover" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->nama}}</td>
                                    <td>
                                        <form action="/satuan/{{$item->id}}" id="delete-form">
                                            <a href="/satuan/{{$item->id}}/edit"
    ...
    function confirmDelete(button) {
        ...
        .then((willDelete) => {
            if (willDelete) {
              ...
              form.action = '/satuan/' + id; // Ubah aksi form sesuai dengan ID yang sesuai
              form.submit();
            }
        });
    }
